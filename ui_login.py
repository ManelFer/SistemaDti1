...
"}")
    ...
    def retranslateUi(self, Ui_Login):
        ...
        self.label.setText(QCoreApplication.translate("Ui_Login", u"<html><head/><body><p align=\"center\"><img src=\":/icons/icons/logo_.png\"/></p></body></html>", None))
        self.label_3.setText(QCoreApplication.translate("Ui_Login", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">Sistema de Controle</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Ui_Login", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:700;\">Login</span></p></body></html>", None))
        self.line_user.setPlaceholderText(QCoreApplication.translate("Ui_Login", u"Usu\u00e1rio", None))
        self.line_pass.setPlaceholderText(QCoreApplication.translate("Ui_Login", u"Senha", None))
        self.btn_login.setText(QCoreApplication.translate("Ui_Login", u"Login", None))
        self.txt_user.setText(QCoreApplication.translate("Ui_Login", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:700;\">Usuer</span></p></body></html>", None))
        self.txt_pass.setText(QCoreApplication.translate("Ui_Login", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:700;\">Password</span></p></body></html>", None))
    # retranslateUi
