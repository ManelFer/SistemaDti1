...
class Ui_Ui_Main(object):
    def setupUi(self, Ui_Main):
        ...
        Ui_Main.resize(722, 413)
        Ui_Main.setStyleSheet(u"background-color: rgb(249, 248, 235);")
...
"}")
    ...
    def retranslateUi(self, Ui_Main):
        Ui_Main.setWindowTitle(QCoreApplication.translate("Ui_Main", u"MainWindow", None))
        self.label_3.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:700;\">DTI Controle</span></p></body></html>", None))
        self.btn_home.setText(QCoreApplication.translate("Ui_Main", u"Home", None))
        self.btn_cadastrar.setText(QCoreApplication.translate("Ui_Main", u"Cadastrar", None))
        self.btn_contatos.setText(QCoreApplication.translate("Ui_Main", u"Contatos", None))
        self.btn_sobre.setText(QCoreApplication.translate("Ui_Main", u"Sobre", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), QCoreApplication.translate("Ui_Main", u"Page 1", None))
        self.label_11.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Usu\u00e1rio:</span> Manoel</p><p align=\"center\"><span style=\" font-weight:700;\">Sistema:</span> Controle</p><p align=\"center\"><span style=\" font-weight:700;\">Status:</span> Ativo</p><p align=\"center\"><span style=\" font-weight:700;\">Hora:</span> hh:mm</p></body></html>", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), QCoreApplication.translate("Ui_Main", u"Page 2", None))
        self.btn_toggle.setText("")
        self.label.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:700;\">Sistema de Controle</span></p></body></html>", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Ui_Main", u"Patrimonio", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Ui_Main", u"Marca", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Ui_Main", u"Modelo", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Ui_Main", u"Quantidade", None));
        self.btn_excel.setText(QCoreApplication.translate("Ui_Main", u"Gerar Excel", None))
        self.btn_alterar.setText(QCoreApplication.translate("Ui_Main", u"Alterar", None))
        self.btn_excluir.setText(QCoreApplication.translate("Ui_Main", u"Excluir", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Ui_Main", u"Produtos", None))
        self.label_5.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Cadastrar</span></p></body></html>", None))
        self.txt_quantidade.setPlaceholderText(QCoreApplication.translate("Ui_Main", u"Quantidade", None))
        self.txt_modelo.setPlaceholderText(QCoreApplication.translate("Ui_Main", u"Modelo", None))
        self.txt_marca.setPlaceholderText(QCoreApplication.translate("Ui_Main", u"Marca", None))
        self.txt_patrimonio.setPlaceholderText(QCoreApplication.translate("Ui_Main", u"Patrimonio", None))
        self.pushButton.setText(QCoreApplication.translate("Ui_Main", u"Cadastrar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("Ui_Main", u"Cadastrar", None))
        self.label_10.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">Contatos</span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><img src=\":/icons/icons/whatsApp.png\"/><span style=\" font-size:18pt; vertical-align:super;\">(79) 9 9918-9735</span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><img src=\":/icons/icons/email.png\"/><span style=\" font-size:18pt; vertical-align:super;\">manoelferreiramatos.ti@gmail.com</span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:700;\">Um sistema simples usando PyQt6. Nele \u00e9 possivel fazer sistemas com o python de maneira simples e completa. Esse projeto est\u00e1 sendo usado para controle de estoque na sala de trabalho.</span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p><img src=\":/icons/icons/logo_.png\"/></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\"><img src=\":/icons/icons/logo_.png\"/></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Ui_Main", u"<html><head/><body><p align=\"center\">DTI Coordena\u00e7\u00e3o \u00a9 2024 Manoel Ferreira Matos.</p></body></html>", None))
    # retranslateUi
